...
const CommentsForm = ({ slug }) => {
  ...
  const handleCommentSubmission = () => {
    ...
    if (typeof window !== "undefined") {
      console.log("localStorage is ", window.localStorage);
    }
    if (storeData) {
    ...
    <>
      <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-18">
        ...
        <div className="grid grid-cols-1 gap-4 mb-4">
          <textarea
            ref={commentEl}
            className="p-4 outline-none w-full rounded-lg focus:ring-2 focus:bg-gray-100 text-gray-700 bg-gray-200"
            placeholder="Comment"
            name="comment"
          />
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
          <input
            type="text"
            ref={nameEl}
            className="py-2 px-4  outline-none w-full rounded-lg focus:ring-2 focus:bg-gray-100 text-gray-700 bg-gray-200"
            placeholder="name"
            name="name"
          />
          <input
